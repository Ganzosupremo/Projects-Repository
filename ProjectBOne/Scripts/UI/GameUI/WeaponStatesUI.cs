...
public class WeaponStatesUI : MonoBehaviour
{
    ...
    private void UpdateAmmoText(Weapon weapon)
    {
        ...
        {
            remainingBulletsText.text = weapon.weaponTotalAmmoCapacity.ToString() + "/" + weapon.weaponDetails.weaponTotalAmmoCapacity.ToString();
        }
    }
    ...
    {
        if ((!weapon.weaponDetails.hasInfinityMagCapacity) && (weapon.weaponClipRemaining <= 0 || weapon.isWeaponReloading))
        {
