...
public class AStarTest : MonoBehaviour
{
    ...
    private Vector3Int noValue = new Vector3Int(99999,99999,99999);
    ...
    {
        if (position.x < instantiatedRoom.room.tilemapLowerBounds.x || position.x > instantiatedRoom.room.tilemapUpperBounds.x ||
            position.y < instantiatedRoom.room.tilemapLowerBounds.y || position.y > instantiatedRoom.room.tilemapUpperBounds.y)
        {
            return false;
        }
        else
