...
/// <summary>
/// Writes to and Read from the disk, saving all the <see cref="GameData"/> from 
/// the scripts that implement the <see cref="IPersistenceData"/> interface.
/// It comunicates with the <see cref="PersistenceDataManager"/> to know which data to write and read.
/// </summary>
public class FileDataHandler
{
    ...
    private readonly string codeWord = "Bitcoin4Life";
