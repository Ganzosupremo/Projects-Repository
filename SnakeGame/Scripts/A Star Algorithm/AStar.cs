...
public static class AStar
{
    ...
    public static Stack<Vector3> BuildPath(Room room, Vector3Int startGridPosition, Vector3Int endGridPosition)
    {
        ...
        List<AStarNode> openNodeList = new();
    ...
    private static AStarNode FindShortestPath(AStarNode startNode, AStarNode endNode, GridNode gridNode, Heap<AStarNode> openNodeList, HashSet<AStarNode> closedNodeHashset, InstantiatedRoom instantiatedRoom)
    {
        ...
        while (openNodeList.Count > 0)
        {
            ...
            AStarNode currentNode = openNodeList.RemoveFirst();
